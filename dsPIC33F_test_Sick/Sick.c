...
/*switch(channel)
    {
        case 0:
            Sector[0] = ADC1BUF0;
            if(Sector[0] > Threshold[0] + MARGIN_SICK && Old_Sector[0] == 0)
            {
                Old_Sector[0] = 1;
                // TODO envoyer ATP Sick1
            }
            else if(Sector[0] < Threshold[0] - MARGIN_SICK && Old_Sector[0] == 1)
            {
                Old_Sector[0] = 0;
                // TODO envoyer ATP Free1
            }
            _CH0SA = Dist_2;
        break;
        case 1:
            Sector[1] = ADC1BUF0;
            if(Sector[1] > Threshold[1] + MARGIN_SICK && Old_Sector[1] == 0)
            {
                Old_Sector[1] = 1;
                // TODO envoyer ATP Sick
            }
            else if(Sector[1] < Threshold[1] - MARGIN_SICK && Old_Sector[1] == 1)
            {
                Old_Sector[1] = 0;
                // TODO envoyer ATP Free2
            }
            _CH0SA = Dist_1;
        break;
    }*/